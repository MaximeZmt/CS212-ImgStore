 ...
 ********************************************************************** */
int
do_list_cmd (int argc, char* argv[]) //const char* filename _unused
{
    // argv[1]
    if (argc < 2) {
...
********************************************************************** */
int
do_create_cmd (int argc, char* argv[]) // const char* filename _unused
{
    // argv[1]
...
********************************************************************** */
int
do_delete_cmd (int argc, char* argv[]) //const char* filename _unused, const char* imgID _unused
{
    //argv[1], argv[2]
    int error = ERR_NONE;
...
int do_insert_cmd(int argc, char* argv[])
{
    ...
    uint64_t size_of_buffer = (uint64_t)signed_size_of_buffer;

    fseek(file, 0, SEEK_SET);

    char* img_buffer = calloc(1, size_of_buffer);

    fread(img_buffer, size_of_buffer, 1, file);
    fclose(file);
